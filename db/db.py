...
class DatabaseManager:
    ...
    def initialize_db(cls):
        ...
        if need_create:
            ...
            initial_users = [
                UserTable(username='1', password='c4ca4238a0b923820dcc509a6f75849b', name='AAAAdmin'),
                UserTable(username='qwe', password='202cb962ac59075b964b07152d234b70', name='Admin'),
            ]
